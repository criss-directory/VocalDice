    ...
    <div className="bg-background text-foreground">
      ...
      <main className="container mx-auto px-4 py-24 sm:py-32">
        <div className="prose prose-invert max-w-4xl mx-auto">
          ...
          <p>At VocalDice, we treat data security as a core part of our product. We follow strict technical and organizational measures to protect your information and your clients’ information.</p>
