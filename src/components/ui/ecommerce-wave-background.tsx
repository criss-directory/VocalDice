...
export const EcommerceWaveBackground = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < lineCount; i++) {
        ...
        // Ecommerce brand colors: purple to pink range - reduced intensity
        const hue = 280 + i * 1.2; // Purple to pink range
...
export default EcommerceWaveBackground;
