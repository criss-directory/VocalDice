...
export const MedicalWaveBackground = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < lineCount; i++) {
        ...
        // Medical/Healthcare brand colors: emerald to teal range
        const hue = 170 + i * 0.8; // Emerald to teal range
...
export default MedicalWaveBackground;
