    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-muted-foreground text-lg text-center max-w-2xl mx-auto mb-12">
          We handle everything building, training, testing, and integrating your AI ISA so it performs at Dubai standards from day one.
        </p>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-background flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-gradient-to-br from-primary to-accent border border-primary/30 p-2" />
              </div>
